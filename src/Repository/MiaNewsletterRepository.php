...
namespace Mia\Newsletter\Repository;

use \Illuminate\Database\Capsule\Manager as DB;

/**
 * Description of MiaNewsletterRepository
 *
 * @author matiascamiletti
 */
class MiaNewsletterRepository 
{
    /**
     * 
    ...
    {
        $query = \Mia\Newsletter\Model\MiaNewsletter::select('mia_newsletter.*');
