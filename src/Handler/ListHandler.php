 ...
 * 
 * @OA\Post(
 *     path="/mia_newsletter/list",
 *     summary="MiaNewsletter List",
 *     tags={"MiaNewsletter"},
 *     @OA\RequestBody(
 ...
 *                      property="response",
 *                      type="array",
 *                      @OA\Items(type="object", ref="#/components/schemas/MiaNewsletter")
 *                  )
 *              }
 *          )
 *     ),
...
class ListHandler extends \Mia\Auth\Request\MiaAuthRequestHandler
{
    ...
    public function handle(\Psr\Http\Message\ServerRequestInterface $request): \Psr\Http\Message\ResponseInterface 
    {
        ...
        $rows = \Mia\Newsletter\Repository\MiaNewsletterRepository::fetchByConfigure($configure);
